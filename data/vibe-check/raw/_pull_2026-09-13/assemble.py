...
def assemble(group, abbrs, date="2026-09-13", week="reg-2"):
    clubs, errors = [], []
    for abbr in abbrs:
...
if __name__ == "__main__":
    assemble(sys.argv[1], sys.argv[2].split(","), date=sys.argv[3] if len(sys.argv) > 3 else "2026-09-13", week=sys.argv[4] if len(sys.argv) > 4 else "reg-2")
